...
import { getRestaurantAction, updateRestaurantAction } from "../../actions";
...
export default async function EditRestaurantPage({
  ...
  const restaurant = await getRestaurantAction(id);
    ...
    <div className="min-h-screen bg-gray-100">
      <nav className="bg-white shadow-sm">
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center">
          <h1 className="text-xl font-semibold text-gray-900">Editar restaurante</h1>
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        ...
        <form action={updateRestaurantAction.bind(null, id)} className="bg-white shadow rounded-lg p-6 space-y-6">
          <div>
          ...
          <div>
            ...
            <input
              ...
              name="accent_color"
              type="color"
              defaultValue={restaurant.accent_color}
